...
padding-bottom: 2rem;
background:
linear-gradient(90deg, var(--ledger-blood) 0, var(--ledger-blood) 0.42rem, transparent 0.42rem),
linear-gradient(180deg, var(--ledger-gold) 0, var(--ledger-gold) 0.28rem, transparent 0.28rem),
var(--ledger-bg);
color: var(--ledger-paper);
...
body > * {
width: min(calc(100vw - 1.6rem), var(--page-max));
margin-left: auto;
margin-right: auto;
}
#title-block-header {
...
border-bottom: 0.24rem solid var(--ledger-blood);
}
...
border-bottom: 0.18rem solid var(--ledger-blood);
}
h2 {
color: var(--ledger-gold);
font-size: clamp(2rem, 9.5vw, 4.3rem);
margin-top: 2.45rem;
...
font-size: clamp(1.45rem, 6.8vw, 3rem);
margin-top: 1.65rem;
...
body > * {
width: min(calc(100vw - 5rem), var(--page-max));
}
}
...
padding-top: 0.9rem;
background:
linear-gradient(90deg, var(--ledger-blood) 0, var(--ledger-blood) 0.32rem, transparent 0.32rem),
linear-gradient(180deg, var(--ledger-gold) 0, var(--ledger-gold) 0.22rem, transparent 0.22rem),
var(--ledger-bg);
}
body > * {
width: min(calc(100vw - 1.1rem), var(--page-max));
}
#title-block-header {
padding-top: 0.65rem;
